...
prueba ={"id": "4", "nombre": "Yeimi", "apellido": "escobar", "username": "Miguelito123", "phone": 3015605651}
prueba2 = {"id": "5", "nombre": "Yulieth", "apellido": "ocampo", "username": "Angelito123", "phone": 3015605654}

i = 0

while i < len(usuarios):
    if i == 0:
        lista.insertar_a_listaVacia(usuarios[i])
        i += 1
    else: 
        lista.insertar_despues_del_elemento(usuarios[i-1],usuarios[i])
        i += 1
...
lista.insertar_antes_del_elemento(usuarios[2], prueba2)
